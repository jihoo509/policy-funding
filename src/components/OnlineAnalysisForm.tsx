    ...
    <div className="w-full max-w-md relative z-10">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="pt-2">
            <Button type="submit" disabled={!formData.name || !formData.birthDateFirst || !formData.birthDateSecond || !formData.gender || !formData.phoneNumber || !formData.companyName || !formData.businessNumber || !formData.existingLoanStatus || !formData.isLoanOverdue || !formData.hasAppliedForPolicyFund || !formData.agreedToTerms || isSubmitting} className="w-full h-14 bg-[#f59e0b] hover:bg-[#d97706] text-white text-xl disabled:opacity-50">
